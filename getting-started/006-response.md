...
> [/v1/search?api_key={YOUR-KEY}&text=YMCA&___size=1___](https://search.mapzen.com/v1/search?api_key={YOUR_API_KEY}&text=YMCA&size=1)

If you want 25 results, you can build the query where `size` is 25.

> [/v1/search?api_key={YOUR-KEY}&text=YMCA&___size=25___](https://search.mapzen.com/v1/search?api_key={YOUR_API_KEY}&text=YMCA&size=25)
